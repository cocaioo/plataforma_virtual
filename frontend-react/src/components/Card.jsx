...
const Card = ({ title, to, icon: Icon, inDevelopment }) => {
  return (
    <div className="bg-white dark:bg-slate-900 shadow-md rounded-lg p-6 text-center flex flex-col h-full">
      <div className="flex-grow">
        {Icon && <Icon className="mx-auto h-12 w-12 text-gray-400 dark:text-slate-500" />}
